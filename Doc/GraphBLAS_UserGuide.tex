...
Version 2.1 is a major update with support for new matrix formats
...
The next version of SuiteSparse:GraphBLAS (Version 2.2) will use
\verb'GxB_BY_ROW' as its default format.
...
function. {\bf NOTE: the default format will change to
\verb'GxB_BY_ROW' in the next release.}
...
The current default format is by column, just like MATLAB
({\bf note this will change in GraphBLAS Version 2.2, and
\verb'GxB_BY_ROW' will become the default format}).

The default format is given by the
