...
or \verb'PAGERANK_' as exemplified in the \verb'my_pagerank.m4' example).
...
passed to an \verb'm4' macro since it is interpretted by \verb'm4' as two
...
occur.  If \verb'my_pagerank.m4' is placed in \verb'GraphBLAS/User/', then
